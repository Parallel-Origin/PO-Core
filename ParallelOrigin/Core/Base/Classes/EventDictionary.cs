...
namespace ParallelOrigin.Core.Base.Classes {
    ...
    public class EventDictionary<K,V> : IDictionary<K,V> {
        ...
        public EventDictionary() { Dictionary = new Dictionary<K, V>(4);  }
        public EventDictionary(int size) { Dictionary = new Dictionary<K, V>(size); }
        ...
        public bool Contains(KeyValuePair<K, V> item) { return Dictionary.Contains(item); }
