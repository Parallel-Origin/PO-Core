...
namespace ParallelOrigin.Core.Base.Classes {
    ...
    public class EventStack<TK, T>  {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual Tuple<TK, T> Peek() { return new Tuple<TK, T>(CurrentKey, CurrentElement); }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual bool IsEmpty() { return CurrentElement == null && ElementStack.Count == 0; }
        ...
        /// </summary>
        public Stack<TK> Keys { get; set; } = new Stack<TK>();

        /// <summary>
        ///     Stack of our UI-Element history
        /// </summary>
        public Stack<T> ElementStack { get; set; } = new Stack<T>();
