...
namespace ParallelOrigin.Core.Base.Classes.Pattern.Storage {
    /// <summary>
...
//    [HostProtection(Synchronization = true, ExternalThreading = true)]
    public class ConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary {
        ...
        public ConcurrentDictionary(int concurrencyLevel, int capacity, IEqualityComparer<TKey> comparer) {
            if (concurrencyLevel < 1) throw new ArgumentOutOfRangeException("concurrencyLevel", GetResource("ConcurrentDictionary_ConcurrencyLevelMustBePositive"));
            if (capacity < 0) throw new ArgumentOutOfRangeException("capacity", GetResource("ConcurrentDictionary_CapacityMustNotBeNegative"));
            if (comparer == null)
                throw new ArgumentNullException("comparer");
        ...
        /// TValue}" />.</param>
        /// <returns>
        ///     true if the <see cref="ConcurrentDictionary{TKey, TValue}" /> contains an element with
        ...
        private void InitializeFromCollection(IEnumerable<KeyValuePair<TKey, TValue>> collection) {
            ...
            foreach (var pair in collection) {
                ...
                if (!TryAddInternal(pair.Key, pair.Value, false, false, out dummy)) throw new ArgumentException(GetResource("ConcurrentDictionary_SourceContainsDuplicateKeys"));
            }
        }
        ...
        /// </param>
        /// <returns>
        ///     true if the key/value pair was added to the <see cref="ConcurrentDictionary{TKey, 
        /// TValue}" />
        ...
        ///     <see cref="ConcurrentDictionary{TKey,TValue}" /> or the default value of
        ///     <typeparamref
        ///         name="TValue" />
        ...
        private bool TryAddInternal(TKey key, TValue value, bool updateIfExists, bool acquireLock, out TValue resultingValue) {
            ...
            while (true) {
                ...
                try {
                    ...
                    for (var node = buckets[bucketNo]; node != null; node = node.m_next) {
                        ...
                        if (m_comparer.Equals(node.m_key, key)) {
                            ...
                            else { resultingValue = node.m_value; }
                ...
                //
                if (resizeDesired) GrowTable(buckets);
        ...
        public TValue GetOrAdd(TKey key, Func<TKey, TValue> valueFactory) {
            ...
            if (TryGetValue(key, out resultingValue)) return resultingValue;
        ...
        public TValue AddOrUpdate(TKey key, Func<TKey, TValue> addValueFactory, Func<TKey, TValue, TValue> updateValueFactory) {
            ...
            while (true) {
                ...
                else //try add
                {
                    ...
                    if (TryAddInternal(key, newValue, false, true, out resultingValue)) return resultingValue;
                }
            }
        }
        ...
        public TValue AddOrUpdate(TKey key, TValue addValue, Func<TKey, TValue, TValue> updateValueFactory) {
            ...
            while (true) {
                ...
                {
                    if (TryAddInternal(key, addValue, false, true, out resultingValue)) return resultingValue;
                }
            }
        }
        ...
        /// </summary>
        /// <value>
        ///     true if the <see cref="ConcurrentDictionary{TKey,TValue}" /> is empty; otherwise,
        ///     false.
        /// </value>
        public bool IsEmpty {
            get {
        ...
        /// </summary>
        private static int DefaultConcurrencyLevel => DEFAULT_CONCURRENCY_MULTIPLIER * System.Environment.ProcessorCount;
        ...
        private class DictionaryEnumerator : IDictionaryEnumerator {
            ...
            internal DictionaryEnumerator(ConcurrentDictionary<TKey, TValue> dictionary) { m_enumerator = dictionary.GetEnumerator(); }
        ...
        void IDictionary.Remove(object key) {
            ...
            TValue throwAwayValue;
            if (key is TKey) TryRemove((TKey) key, out throwAwayValue);
        }
        ...
        object IDictionary.this[object key] {
            get {
                ...
                TValue value;
                if (key is TKey && TryGetValue((TKey) key, out value)) return value;
